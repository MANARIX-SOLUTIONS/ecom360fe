...
export async function createExpenseCategory(req: ExpenseCategoryRequest): Promise<ExpenseCategoryResponse> {
...
export async function updateExpense(id: string, req: Partial<ExpenseRequest>): Promise<ExpenseResponse> {
