...
export async function listSuppliers(params?: { page?: number; size?: number }): Promise<PageResponse<SupplierResponse>> {
...
export async function updateSupplier(id: string, req: Partial<SupplierRequest>): Promise<SupplierResponse> {
