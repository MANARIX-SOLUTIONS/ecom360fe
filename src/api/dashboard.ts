...
export type DashboardResponse = {
  ...
  totalStores: number
  lowStockItems: { productName: string; storeName: string; quantity: number; minStock: number }[]
  recentSales: { receiptNumber: string; total: number; paymentMethod: string; createdAt: string }[]
