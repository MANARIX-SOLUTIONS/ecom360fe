  ...
  return (
    <div className={`${styles.settingsPage} pageWrapper`}>
      ...
      <Card bordered={false} className={styles.settingsCard}>
        <Typography.Text type="secondary" className={styles.settingsPageSubtitle} style={{ marginBottom: 20, display: 'block' }}>
        ...
        >
          ...
          >
            <Input.Password prefix={<Lock size={18} />} placeholder="••••••••" autoComplete="current-password" />
          </Form.Item>
          <Form.Item
            name="newPassword"
          ...
          >
            <Input.Password prefix={<Lock size={18} />} placeholder="••••••••" autoComplete="new-password" />
          </Form.Item>
          <Form.Item
